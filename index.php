...
[<a href="index.php">Home</a>] [<a href="specs.php">Computer Specs</a>] [<a href="social.php">Social Accounts</a>]
		...
		<div class="content">
			<img src="lainglitchy3.gif" style="height:500px;width:auto;margin-left:90px;" />
		</div>
		
		<div class="footer">
			<!--<p><iframe frameborder="0" scrolling="no" marginheight="0" marginwidth="0" width="551" height="310" type="text/html" src="https://www.youtube.com/embed/kZa0HGNHKe4?autoplay=0&fs=0&iv_load_policy=3&showinfo=0&rel=0&cc_load_policy=0&start=0&end=0">&nbsp;</iframe></p>-->
		</div>
	</div>
	</body>
</html>